...
.tigre-section {
  ...
  gap: 100px; /* distância entre texto e imagem */
  overflow: hidden;
}
...
.tigre-section .imagem-tigre img {
  max-width: 480px; /* proporção harmoniosa com o texto */
  height: auto;
  display: block;
  object-fit: contain;
}
...
<section class="colecao-section">
  ...
  <div class="colecao-container">
    <div class="produto-card">
      <img src="../imgs/brinco2.png" alt="Brinco Pingo de Sol" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Brinco Pingo de Sol')">
      <h3>Pingo de Sol</h3>
      <button onclick="adicionarCarrinho('Brinco Pingo de Sol')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card">
      <img src="../imgs/brinco3.png" alt="Brinco Caminho de Lúmen" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Brinco Caminho de Lúmen')">
      <h3>Caminho de Lúmen</h3>
      <button onclick="adicionarCarrinho('Brinco Caminho de Lúmen')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card" onclick="window.location.href='brinco_detalhe.html'">
      <img src="../imgs/brinco4.png" alt="Brinco Coração Puro" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Brinco Coração Puro')">
      <h3>Coração Puro</h3>
      <button onclick="adicionarCarrinho('Brinco Coração Puro')">Adicionar ao carrinho</button>
    </div>
  </div>

  <!-- Mensagem central Curtida -->
