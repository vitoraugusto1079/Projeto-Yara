      ...
      <nav class="menu" role="navigation" aria-label="Menu principal"> 
        ...
        <div class="menu-item acessorios"> 
          ...
          <div class="dropdown"> 
            ...
            <div> 
              <h4>Experiências</h4> 
              <a href="conjunto.html">Monte seu Conjunto</a> 
...
.olhos-section .imagem-tigre img {
  max-width: 300px; /* mesmo tamanho da imagem da tigre */
  width: 100%;
  height: auto;
  display: block;
}
...
<section class="colecao-section">
  ...
  <div class="colecao-container">
    <div class="produto-card">
      <img src="../imgs/piercing1.png" alt="Piercing Helix" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Piercing Helix')">
      <h3>Piercing Helix</h3>
      <button onclick="event.stopPropagation(); adicionarCarrinho('Piercing Helix')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card">
      <img src="../imgs/piercing2.png" alt="Piercing Nostril" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Piercing Nostril')">
      <h3>Piercing Nostril</h3>
      <button onclick="event.stopPropagation(); adicionarCarrinho('Piercing Nostril')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card">
      <img src="../imgs/piercing3.png" alt="Piercing Tragus" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Piercing Tragus')">
      <h3>Piercing Tragus</h3>
      <button onclick="event.stopPropagation(); adicionarCarrinho('Piercing Tragus')">Adicionar ao carrinho</button>
    </div>
  </div>
  </div>
...
function curtirProduto(elemento, nome) {
  ...
  // Oculta automaticamente depois de 4 segundos
