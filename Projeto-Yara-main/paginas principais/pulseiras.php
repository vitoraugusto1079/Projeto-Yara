...
<section class="colecao-section">
  ...
  <div class="colecao-container">
    <div class="produto-card">
      <img src="../imgs/pulseira1.png" alt="Pulseira Pink Charm" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Pulseira Pink Charm')">
      <h3>Pink Charm</h3>
      <button onclick="adicionarCarrinho('Pulseira Pink Charm')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card">
      <img src="../imgs/pulseira2.png" alt="Pulseira Serineté" class="produto-img">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Pulseira Serineté')">
      <h3>Serineté</h3>
      <button onclick="adicionarCarrinho('Pulseira Serineté')">Adicionar ao carrinho</button>
    </div>

    <div class="produto-card">
      <img src="../imgs/pulseira3.png" alt="Pulseira Flor de Sakura" class="produto-img" onclick="window.location.href='pulseira_detalhe.html'">
      <img src="../imgs/coracao.png" alt="Curtir" class="favorito" onclick="curtirProduto(this, 'Pulseira Flor de Sakura')">
      <h3>Flor de Sakura</h3>
      <button onclick="adicionarCarrinho('Pulseira Flor de Sakura')">Adicionar ao carrinho</button>
    </div>
  </div>
